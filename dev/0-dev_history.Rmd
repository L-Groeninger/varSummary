...
fusen::fill_description(
  ...
  fields = list(
    ...
    Description = "Creating a named list with value count information of variables of a dataframe",
    `Authors@R` = c(
      person("Sebastien", "Rochette", email = "lukas.groeninger@gmail.com", role = c("aut", "cre"))
    )
  ))
